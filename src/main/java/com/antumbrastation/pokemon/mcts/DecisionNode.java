...
public class DecisionNode {
    ...
    public DecisionNode(BattleState rootState) {
        this.gameState = rootState;
    }

    public DecisionNode(BattleState parent, PlayerMove leftMove, PlayerMove rightMove) {
        this.parent = parent;
    ...
    public double selectDownwards() {
        ...
        if (!expanded) {
            ...
            DecisionNode child = children[chosenPlay.getLeft()][chosenPlay.getRight()];
    ...
    private void expand() {
        ...
        children = new DecisionNode[leftOptions.size()][rightOptions.size()];
        ...
        for (int leftIndex = 0; leftIndex < leftOptions.size(); leftIndex++) {
            for (int rightIndex = 0; rightIndex < rightOptions.size(); rightIndex++) {
                PlayerMove leftMove = leftOptions.get(leftIndex);
                PlayerMove rightMove = rightOptions.get(rightIndex);

                children[leftIndex][rightIndex] = new DecisionNode(gameState, leftMove, rightMove);
            }
        }
    }
